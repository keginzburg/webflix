...
class ProfilesIndexItem extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="profile-index-item-container" onClick={() => { dispatch(receiveCurrentProfile(this.props.profile.id)); this.props.fetchMylistedVideos(this.props.profile.id) }}>
